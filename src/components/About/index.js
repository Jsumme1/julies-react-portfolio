...
import coverAvatar from "../../assets/cover/avatar.png";
        ...
        <div className="flex-container">
          ...
          <div className="my-2 box">
            <p>
              ...
              the operational aspect of the trading business and communicate it
              to downstream operations; be it a physical commodity move, title
              transfer or everything in between. My personal motto is – “It’s
              always great to have a plan A, but you better have plans B, C and
              D ready”. It has served me well in both my professional and
              personal life.{" "}
            </p>
            <p>
              I enrolled in the Rice University Full Stack Web Development
              course to increase my knowledge base in an unfamiliar (to me)
              field. I am able to apply my problem-solving skills and
              adaptability to coding and found that I enjoy the challenge. One
              of my greatest assets is if I don’t know the answer to something,
              I know how to leverage my resources and networks to find a
              solution (and several alternatives!). I am looking forward to an
              opportunity that lets me incorporate my seasoned skills with my
              newfound ones.
            </p>
            <img
              src={coverAvatar}
